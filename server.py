...
from whisper_live.transcriber_tensorrt_whisper_trt import *
import librosa
...
class TranscriptionServer:
    ...
    def initialize_client(
        ...
        if self.backend == "tensorrt":
            ...
            try:
                ...
                logging.info("'Usually It should goes to faster_whisper backend but it is deactivated .")
    ...
    def voice_activity(self, websocket, frame_np):
        ...
        """
        print(self.vad_detector(frame_np))
...
class ServeClientTensorRT(ServeClientBase):
    ...
    def __init__(self, websocket, task="transcribe", multilingual=True, language=None, client_uid=None, model=None, single_model=False):
        """
    ...
    def create_model(self, model, multilingual, warmup=True):
        ...
        print(self.language)
        print(self.task)
        self.transcriber = WhisperTRT(
            model,
            assets_dir="~/.cache/whisper/",
            device="cuda",
    ...
    def warmup(self, warmup_steps=10):
        ...
        audio , _ = librosa.load('/usr/local/lib/python3.10/dist-packages/whisper_live/jfk.flac', sr = 16000)
        for i in range(warmup_steps):
            self.transcriber.transcribe(audio = audio)
    ...
    def transcribe_audio(self, input_bytes):
        ...
        last_segment, duration = self.transcriber.transcribe(audio = input_bytes)
        if ServeClientTensorRT.SINGLE_MODEL:
